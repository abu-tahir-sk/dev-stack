      ...
      <div className="space-y-3">
        ...
        <details className="border border-gray-200 rounded-lg p-4">
          ...
          <p className="text-xs text-gray-500 leading-5 mt-3">
            You can deploy the site anywhere you like, such as
            Netlify, Vercel, Cloudflare Pages, or any other
            hosting platform.
          </p>
        </details>
        ...
        <details className="border border-gray-200 rounded-lg p-4">
          ...
          <p className="text-xs text-gray-500 leading-5 mt-3">
            No. You can use either TypeScript or JavaScript.
        ...
        <details className="border border-gray-200 rounded-lg p-4">
          ...
          <p className="text-xs text-gray-500 leading-5 mt-3">
            Yes. You can change the project title, logo, and
            color scheme as long as they remain relevant to
            the project.
          </p>
        </details>
        ...
        <details className="border border-gray-200 rounded-lg p-4">
          ...
          <p className="text-xs text-gray-500 leading-5 mt-3">
            You can use technology icon URLs from different
            sources. TechIcons is one useful source for clean
            technology logos.
          </p>
        </details>
